...
export const CATEGORIES: Category[] = [
  {
    ...
    skills: [
      ...
      { name: "Framer Motion", Icon: SiFramer, color: "#0055FF", level: 86 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "PostgreSQL", Icon: SiPostgresql, color: "#316192", level: 78 },
      { name: "JavaScript", Icon: SiJavascript, color: "#F0DC4E", level: 78 },
      { name: "MongoDB", Icon: SiMongodb, color: "#11AA52", level: 76 },
      { name: "Prisma", Icon: SiPrisma, color: "#2D3748", level: 72 },
    ],
  },
  {
    title: "Tooling & QA",
    Icon: SiVite,
    skills: [
      { name: "Vite", Icon: SiVite, color: "#A545FF", level: 84 },
      { name: "Jest", Icon: SiJest, color: "#C21325", level: 74 },
      { name: "RTL", Icon: SiTestinglibrary, color: "#E44D26", level: 70 },
